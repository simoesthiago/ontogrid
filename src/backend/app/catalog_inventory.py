...
_DATASET_OVERRIDES = {
    ...
    ("ons", "carga-de-energia-diaria"): {
        "id": "ds-ons-carga-diaria",
        "code": "carga_energia_diaria",
        "name": "Carga de energia diaria",
        "domain": "Carga, balanco e programacao",
        "description": "Serie diaria agregada de carga por submercado a partir do portal publico do ONS.",
        "granularity": "day",
        "refresh_frequency": "daily",
        "schema_summary": {"dimensions": ["submarket"], "metrics": ["load_avg_mw"]},
    },
    ...
    ("aneel", "siga-sistema-de-informacoes-de-geracao-da-aneel"): {
        "id": "ds-aneel-siga",
        "code": "siga_geracao_aneel",
        "name": "SIGA - cadastro de geracao",
        "domain": "Geracao, outorgas e expansao",
        "description": "Cadastro mestre de usinas, agentes e localizacao do parque gerador.",
        "granularity": "static",
        "refresh_frequency": "daily",
        "schema_summary": {"dimensions": ["plant", "agent", "municipality"], "metrics": ["installed_capacity_mw"]},
    },
    ("aneel", "indicadores-coletivos-de-continuidade-dec-e-fec"): {
        "id": "ds-aneel-dec-fec",
        "code": "indicadores_dec_fec",
        "name": "Indicadores coletivos DEC e FEC",
        "domain": "Distribuicao, qualidade e atendimento",
        "description": "Serie mensal de continuidade de distribuicao por concessionaria e municipio.",
        "granularity": "month",
        "refresh_frequency": "monthly",
        "schema_summary": {"dimensions": ["distributor", "municipality"], "metrics": ["dec_hours", "fec_index"]},
    },
    ("aneel", "agentes-de-geracao-de-energia-eletrica"): {
        "id": "ds-aneel-agentes-geracao",
        "code": "agentes_geracao_aneel",
        "name": "Agentes de geracao de energia eletrica",
        "domain": "Geracao, outorgas e expansao",
        "description": "Cadastro publico de agentes geradores da ANEEL com capacidade outorgada agregada.",
        "granularity": "month",
        "refresh_frequency": "monthly",
        "schema_summary": {"dimensions": ["agent"], "metrics": ["granted_capacity_mw"]},
    },
    ("ons", "geracao-por-usina-em-base-horaria"): {
        "id": "ds-ons-geracao-usina",
        "code": "geracao_usina_horaria",
        "name": "Geracao por usina em base horaria",
        "domain": "Geracao e usinas",
        "description": "Serie horaria de geracao verificada por usina com reconciliacao de agente e geografia eletrica.",
        "granularity": "hour",
        "refresh_frequency": "daily",
        "schema_summary": {"dimensions": ["plant", "submarket"], "metrics": ["generation_mw"]},
    },
    ...
    ("ccee", "pld-media-diaria"): {
        "id": "ds-ccee-pld-media-diaria",
        "code": "pld_media_diaria",
        "name": "PLD medio diario por submercado",
        "domain": "Preco de liquidacao das diferencas",
        "description": "Serie diaria do PLD medio por submercado publicada pela CCEE.",
        "granularity": "day",
        "refresh_frequency": "daily",
        "schema_summary": {"dimensions": ["submarket"], "metrics": ["pld_avg_rs_mwh"]},
    },
    ("ccee", "lista-agente-associado"): {
        "id": "ds-ccee-agentes",
        "code": "agentes_mercado_ccee",
        "name": "Agentes de mercado da CCEE",
        "domain": "Agentes de Mercado",
        "description": "Cadastro de agentes associados da CCEE com CNPJ, sigla e classe de mercado.",
        "granularity": "month",
        "refresh_frequency": "monthly",
        "schema_summary": {"dimensions": ["agent"], "metrics": []},
    },
    ("ccee", "geracao-horaria-usina"): {
        "id": "ds-ccee-infomercado-geracao",
        "code": "infomercado_geracao_horaria_usina",
        "name": "Infomercado - geracao horaria por usina",
        "domain": "Infomercado",
        "description": "Serie contabilizada de geracao por usina com associacao a agente e submercado.",
        "granularity": "hour",
        "refresh_frequency": "daily",
        "schema_summary": {"dimensions": ["plant", "agent", "submarket"], "metrics": ["accounted_generation_mwh"]},
    },
}
